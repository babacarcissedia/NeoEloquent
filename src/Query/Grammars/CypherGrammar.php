...
class CypherGrammar extends Grammar
{
     ...
     * @return array
     */
    protected function compileComponents($query, $specified = null)
    {
        $cypher = [];
     ...
     * @return string
     */
    public function compileMatches($query, $matches)
    {
     ...
     * @return string
     */
    protected function whereCarried($query, $where)
    {
     ...
     * @return string
     */
    protected function compileColumns($query, $properties)
    {
    ...
    public function compileAggregate($query, $aggregate)
    {
        $distinct = null;
     ...
     * @return string
     */
    public function compileOrders($query, $orders)
    {
     ...
     * @return string
     */
    public function compileCreate($query, $values)
    {
    ...
    protected function compileHavings($query)
    {
        $cypher = implode(' ', array_map([$this, 'compileHaving'], $$query->havings));
     ...
     * @return string
     */
    public function compileDelete($query, $isRelationship = false, $shouldKeepEndNode = false)
    {
        // We always need the MATCH clause in our Cypher which
        // is the responsibility of compiling the From component.
    ...
    public function compileWith($query, $with)
    {
        $parts = [];
    ...
    public function compileMatchRelationship($query, $attributes)
    {
     ...
     * @return string
     */
    public function compileRelationship($query, $attributes, $addEndLabel = false)
    {
        $startNode = $this->modelAsNode($attributes['start']['label']);
        $endNode = 'rel_' . $this->modelAsNode($attributes['label']);
    ...
    public function compileCreateRelationship($query, $attributes)
    {
    ...
    public function compileDeleteRelationship($query, $attributes)
    {
        $match = $this->compileMatchRelationship($query, $attributes);
     ...
     * @return string
     */
    public function compileCreateWith($query, $create)
    {
        $model = $create['model'];
     ...
     * @return string
     */
    public function compileUpdateLabels($query, $labels, $operation = 'add')
    {
